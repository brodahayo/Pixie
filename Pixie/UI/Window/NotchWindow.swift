...
/// Custom NSPanel subclass for non-activating, click-through notch overlay.
@MainActor
final class NotchPanel: NSPanel {
    ...
    private nonisolated func repostMouseEvent(_ event: NSEvent, at screenLocation: NSPoint) {
